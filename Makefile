...
CWARN = -Wall -Wextra -Wundef -Wstrict-prototypes -Wdouble-promotion -Wfloat-conversion

# Define C++ warning options here.
CPPWARN = -Wall -Wextra -Wundef -Wdouble-promotion -Wfloat-conversion
